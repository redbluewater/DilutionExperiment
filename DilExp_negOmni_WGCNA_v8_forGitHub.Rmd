...
NameOfFile = 'DilExp_WGCNA_negOmni_log2.2016.05.27_v1.Rimage'
WriteCSVname = 'DilExp_WGCNA_negOmni_log2.2016.05.27_v1.csv'
writeColorsName = 'DilExp_WGCNA_tableColors_log2.2016.05.27_v1.csv'
...
#FT-LC data
wDir = "C:/Users/Krista/Documents/Current projects/DeepDOM_DilutionExperiment/FTLCdata/"
fData = read.csv(paste0(wDir,"DilExp_FTnegOmni.forWGCNA.2016.05.05.csv"))
...
#TSQ data
wDir <- "C:/Users/Krista/Documents/Current projects/DeepDOM_DilutionExperiment/"
traitData = read.csv(paste0(wDir,"DilExp.TSQ.forWGCNA_normBiotinOnly.2016.05.05.csv"))
...
annot = read.csv("FTLCdata/DilExp_FTnegOmni_annotation.forWGCNA.2016.05.05.csv") #
dim(annot)
names(annot)
...
In this next section, I use the merging threshold and soft power found in the previous code chunk. This is specific to this data, and would need to be changed for other data.
...
par(mar = c(15,9,2,3))
#par(mai = c(2,2,1,1))
# par(mar = c(6,5,4,2) +0.1) #this is closer to the default values
...
#complete hack, but might be easier than squinting at the labeled heatmap
# showR <- rbind(moduleTraitCor[,'arginine'],moduleTraitPvalue[,'arginine'])
...
Output some of the modules to Cytoscape
